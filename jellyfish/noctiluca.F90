...
99 call self%fatal_error('Noctiluca', 'Error reading namelist ulg_noctiluca') 
   ...
   _ADD_SOURCE_(self%id_cdi, -Grazing_C/Prey_C*self%eff_noc_dia*CDI)
   ...
   _ADD_SOURCE_(self%id_ndi,- Grazing_C/Prey_C*self%eff_noc_dia*NDI) 
   _ADD_SOURCE_(self%id_sid, Grazing_C/Prey_C*self%eff_noc_dia*NDI*self%r_si_n_dia)
