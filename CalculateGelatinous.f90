...
!     Model parameters 
      ...
      real(rk)     :: r_o2_c_resp, r_p_n_redfield, respb_gel, t_g_gel
   ...
   namelist /ulg_Gelatinous/ doxsatmort, 	 & 
                      ...
                      r_o2_c_resp, r_p_n_redfield, respb_gel, 	 & 
                      t_g_gel
   ...
   call self%get_parameter(self%gmax_gel, 'gmax_gel', 'd-1', 'Maximum grazing rate of GEL', default=0.3_rk) 
   ...
   call self%get_parameter(self%momax_gel, 'momax_gel', '(?) d-1', 'Maximum mortality rate of GEL', default=0.009_rk) 
   ...
   call self%get_parameter(self%respb_gel, 'respb_gel', 'd-1', 'Basal respiration rate of GEL', default=0.0001_rk) 
